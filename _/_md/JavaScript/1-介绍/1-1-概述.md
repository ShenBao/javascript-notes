...
从语法角度看，JavaScript语言是一种“对象模型”语言。各种宿主环境通过这个模型，描述自己的功能和操作接口，从而通过JavaScript控制这些功能。但是，JavaScript并不是纯粹的“面向对象语言”，还支持函数式编程。这导致几乎任何一个问题，JavaScript都有多种解决方法。JavaScript语法应用灵活。
...
JavaScript语言有多个版本。目前最新的版本是ECMAScript 2016，从历史上看，它属于ECMAScript的第6个版本，又称ES6。
